/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3ca6a2ac275675a6972f03741d5ca0d1)
// Runtime types generated with workerd@1.20260714.1 2025-04-03 
interface __BaseEnv_Env {
	BUILDS: R2Bucket;
	DEV: string;
	BUILD_SERVER: string;
	BUILDER: DurableObjectNamespace<import("./src/index").Builder>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Builder";
	}
